...
const Procedure = () => {
  return (
    <>
      <div className=" px-5 lg:px-32 md:px-28">
      ...
      <div className="flex flex-col items-center gap-2 py-5">
        ...
        <div className="py-5 grid grid-cols-1 gap-5  md:grid-cols-5 md:grid-rows-3 lg:grid-cols-5 lg:grid-rows-3 place-items-center">
